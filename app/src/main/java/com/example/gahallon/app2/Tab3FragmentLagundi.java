...
public class Tab3FragmentLagundi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab3_fragment_lagundi,container,false);

        plantLabel = view.findViewById(R.id.plantLabel);
        plantLabel.setText("Lagundi Plant");

        leafLabel = view.findViewById(R.id.leafLabel);
        leafLabel.setText("Lagundi Leaf");

        inflorescenceLabel = view.findViewById(R.id.inflorescenceLabel);
        inflorescenceLabel.setText("Inflorescence of Lagundi");
