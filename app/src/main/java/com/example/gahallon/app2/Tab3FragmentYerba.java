...
public class Tab3FragmentYerba extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab3_fragment_yerba,container,false);

        plantLabel = view.findViewById(R.id.plantLabel);
        plantLabel.setText("Yerba Buena Plant");

        leafLabel = view.findViewById(R.id.leafLabel);
        leafLabel.setText("Yerba Buena Leaf");

//        inflorescenceLabel = view.findViewById(R.id.inflorescenceLabel);
//        inflorescenceLabel.setText("NYerba Buena Flower");
