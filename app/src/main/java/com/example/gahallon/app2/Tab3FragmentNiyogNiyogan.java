...
public class Tab3FragmentNiyogNiyogan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab3_fragment_niyogniyogan,container,false);

        plantLabel = view.findViewById(R.id.plantLabel);
        plantLabel.setText("Niyog-niyogan Plant");

//        leafLabel = view.findViewById(R.id.leafLabel);
//        leafLabel.setText("Akapulko Leaf");

        inflorescenceLabel = view.findViewById(R.id.inflorescenceLabel);
        inflorescenceLabel.setText("Niyog-niyogan Flower");
