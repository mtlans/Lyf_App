...
public class Tab3FragmentAmpalaya extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab3_fragment_ampalaya,container,false);

        plantLabel = view.findViewById(R.id.plantLabel);
        plantLabel.setText("Ampalaya Plant");

        leafLabel = view.findViewById(R.id.leafLabel);
        leafLabel.setText("Ampalaya Leaf");

        inflorescenceLabel = view.findViewById(R.id.inflorescenceLabel);
        inflorescenceLabel.setText("Ampalaya Flower");

        fruitLabel = view.findViewById(R.id.fruitLabel);
        fruitLabel.setText("Ampalaya Fruit");
