...
public class Tab3FragmentTsaang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab3_fragment_tsaang,container,false);

        plantLabel = view.findViewById(R.id.plantLabel);
        plantLabel.setText("Tsaang Gubat Plant");

//        leafLabel = view.findViewById(R.id.leafLabel);
//        leafLabel.setText("Bawang Leaf");

        inflorescenceLabel = view.findViewById(R.id.inflorescenceLabel);
        inflorescenceLabel.setText("Tsaang Gubat Flower");
